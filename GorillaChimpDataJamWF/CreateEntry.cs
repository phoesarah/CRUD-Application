    ...
    public partial class CreateEntry : Form
    {
        ...
        private void SubmiutButton_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedItem.ToString() == "Gor_Habit_Nest")
            {
               ...
               if (NestNumberHabNestTextBox.Text != null)
